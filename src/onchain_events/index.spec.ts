...
test('decode withdraw event data', () => {
  ...
  const eventData =
    '0x00e1f50500000000000000000000000000000000000000000000000000000001035354430353544300';
  const result = decodeEventData(eventName, eventData);
  console.log(result.toJS());
});
...
test('decode mint event data', () => {
  ...
  const eventData =
    '0x80cb29d0000000000000000000000000000000000000000000000000000000010353544303535443';
  const result = decodeEventData(eventName, eventData);
  console.log(result.toJS());
});
...
test('decode vote changed event data', () => {
  ...
  const eventData =
    '0x0a000000000000000000000000000000000000000a550c180000000000000000000000000a550c180100003426f56b1c000000000000000000';
  const result = decodeEventData(eventName, eventData);
  console.log(result.toJS());
});
