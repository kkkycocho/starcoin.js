...
export function getMultiEd25519AccountPrivateKey(
  shard: MultiEd25519KeyShard
): string {
  const privateKey = hexlify(shard.privateKey());
  return privateKey;
}

export function getMultiEd25519AccountPublicKey(
  shard: MultiEd25519KeyShard
): string {
...
export function getMultiEd25519AccountAddress(
  shard: MultiEd25519KeyShard
): string {
...
export function getMultiEd25519AccountReceiptIdentifier(
  shard: MultiEd25519KeyShard
): string {
...
export function showMultiEd25519Account(
  shard: MultiEd25519KeyShard
...
export function decodeMultiEd25519AccountPrivateKey(
  privateKey: string
): Record<string, any> {
